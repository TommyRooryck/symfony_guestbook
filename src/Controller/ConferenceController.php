...
class ConferenceController extends AbstractController
{
    ...
    $photoDir, NotifierInterface $notifier)
    {
        $comment = new Comment();
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $notifier->send(new Notification('Thank you for the feedback; your comment will be posted after review',
                ['browser']));
        ...
        if ($form->isSubmitted()){
            $notifier->send(new Notification('Can you check your submission? Problems found.', ['browser']));
        }
